...
%% compute Nasalance parameter using smoothed energy signals
...
%% compute Nasalance parameter using un-smoothed energy signals
...
% Square the signal.
ySquared_nasal = nasal_filtered .^ 2;
% Get a moving average within a window
% windowWidth = 1000;
% meanSquareY = movmean(ySquared, windowWidth);
